...
setup(
    name='hide',
    version='0.1.0',
    description='A package for simulating of a single dish radio telescope survey',
    long_description=readme + '\n\n' + doclink + '\n\n' + history,
    author='Joel Akeret',
    author_email='jakeret@phys.ethz.ch',
    url='http://github.com/cosmo-ethz/hide',
    packages=find_packages(PACKAGE_PATH, "test"),
    package_dir={'hide': 'hide'},
